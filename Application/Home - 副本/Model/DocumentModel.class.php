...
class DocumentModel extends Model{
	 ...
	 * @return array              文档列表
	 */
	public function lists($lang, $category, $order = '`id` DESC', $status = 1, $field = true){
		$map = $this->listMap($lang, $category, $status);
	...
	public function position($pos, $category = null, $limit = null, $field = true){
		$map = $this->listMap($lang, $category, 1, $pos);
	 ...
	 * @return array             查询条件
	 */
	private function listMap($lang, $category, $status = 1, $pos = null){
		/* 设置状态 */
