      ...
      <div class="span9">
        ...
        <section id="contents">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="">
					<h3 class="ellipsis"><a href="<?php echo U('Article/detail?id='.$data['id']);?>"><?php echo ($data["lang"]); ?>-<?php echo ($data["title"]); ?></a></h3>
				</div>
				<div>
					<p class="lead"><?php echo ($data["description"]); ?></p>
				</div>
				<div>
					<span><a href="<?php echo U('Article/detail?id='.$data['id']);?>">查看全文1112</a></span>
