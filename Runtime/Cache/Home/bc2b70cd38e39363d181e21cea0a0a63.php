...
<div id="main-container" class="container">
    ...
    <ul class="nav nav-list bs-docs-sidenav">
        <li>
            <a href="<?php echo U('edit?model=2&category='.$category['name']);?>" class="btn btn-primary btn-block btn-large">发表话题</a>
        </li>
    </ul>
        ...
        <section id="contents">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div>
                ...
                <div>
                    ...
                    <span>于 <?php echo (date('Y-m-d H:i',$data["create_time"])); ?></span> 发表在 
                    <span><a href=""><?php echo (get_category_title($data["category_id"])); ?></a></span>
