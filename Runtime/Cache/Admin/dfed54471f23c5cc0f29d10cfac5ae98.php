...
<body>
	...
	<div class="tab-wrap">
		...
		<div class="tab-content">
			<form action="/index.php?s=/admin/category/edit/id/1/pid/0.html" method="post" class="form-horizontal">
				<!-- 基础 -->
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						<label class="item-label">
							<em class="must">*</em>分类名称<span class="check-tips">（简体中文）</span>
						</label>
						<div class="controls">
					...
					<div class="form-item">
						<label class="item-label">
							<em class="must">*</em>分类名称<span class="check-tips">（英文）</span>
						</label>
						<div class="controls">
							<input type="text" name="entitle" class="text input-large" value="<?php echo ((isset($info["entitle"]) && ($info["entitle"] !== ""))?($info["entitle"]):''); ?>">
						</div>
					</div>
					<div class="form-item">
						<label class="item-label">
							<em class="must">*</em>分类名称<span class="check-tips">（繁体）</span>
						</label>
						<div class="controls">
							<input type="text" name="twtitle" class="text input-large" value="<?php echo ((isset($info["twtitle"]) && ($info["twtitle"] !== ""))?($info["twtitle"]):''); ?>">
						</div>
					</div>
					<div class="form-item">
						<label class="item-label">
