...
<body>
	...
	<div class="main-title cf">
		<h2><?php if(ACTION_NAME == 'add'): ?>新增<?php else: ?>编辑<?php endif; ?> [<?php echo get_model_by_id($info['model_id']);?>] 属性 : <a href="<?php echo U('index','model_id='.$info['model_id']);?>">返回列表</a></h2>
	</div>
			...
			<form id="form" action="<?php echo U('update');?>" method="post" class="form-horizontal doc-modal-form">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item cf">
						...
						<div class="controls">
							<label class="textarea input-large">
								<textarea name="remark"><?php echo ($info["remark"]); ?></textarea>
							</label>
						</div>
					</div>
					<div class="form-item cf">
