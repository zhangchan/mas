...
<body>
	...
	<form action="/index.php?s=/admin/channel/edit/id/1/pid/0.html" method="post" class="form-horizontal">
		<input type="hidden" name="pid" value="<?php echo ($pid); ?>">
		<div class="form-item">
			<label class="item-label">导航标题<span class="check-tips">（简体中文）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="title" value="<?php echo ((isset($info["title"]) && ($info["title"] !== ""))?($info["title"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">导航标题<span class="check-tips">（英文）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="entitle" value="<?php echo ((isset($info["entitle"]) && ($info["entitle"] !== ""))?($info["entitle"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">导航标题<span class="check-tips">（繁体）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="twtitle" value="<?php echo ((isset($info["twtitle"]) && ($info["twtitle"] !== ""))?($info["twtitle"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
